...
function UserContext({children}) {
    ...
    async function translateText(text, targetLang) {
        const translations = {
            hi: "मेरा नाम Arubi AI है।",
            ur: "میرا نام Arubi AI ہے۔",
            en: "My name is Arubi AI.",
            fr: "Mon nom est Arubi AI.",
            es: "Mi nombre es Arubi AI.",
        };
    ...
    async function takeCommand(command) {
        ...
        let response = await translateText("My name is Arubi AI.", lang);
        speak(response);
        setPrompt(response);
